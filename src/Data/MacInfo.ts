export const menuMacInfo = [
  ...
  {
    title: "Tại Sao Chọn Mac",
    WhyMacCards: [
      {
        icon: "delivery_truck", // Icon xe tải giao hàng
        title: "Giao hàng miễn phí",
        description: "Giao hàng miễn phí đến tận nhà.",
        // Thay thế bằng URL liên kết tương ứng
      },
      {
        icon: "chat_expert", // Icon tư vấn/chat với chuyên gia
        title: "Mua sắm cùng Chuyên Gia Máy Mac",
        description: "Mua sắm trực tiếp với Chuyên Gia trực tuyến.",
      },
      {
        icon: "money_transfer", // Icon trả góp/thanh toán
        title: "Khám phá trả góp cho bạn",
        description:
          "Sử dụng ứng dụng Apple Store để xem các phương thức mua sắm khác nhau.",
      },
      {
        icon: "trade_in_arrows", // Icon đổi cũ lấy mới (Trade In)
        title: "Tiết kiệm với Apple Trade In",
        description:
          "Đổi thiết bị đủ điều kiện của bạn lấy tín dụng cho lần mua hàng tiếp theo.²",
      },
      {
        icon: "education_cap", // Icon bằng cấp/giáo dục
        title: "Tiết kiệm với chính sách giáo dục",
        description:
          "Sinh viên và giảng viên có đặc quyền mua thiết bị với giá tiết kiệm tại Apple Store.***",
      },
      {
        icon: "customize_gear", // Icon tùy chỉnh/bánh răng
        title: "Tùy chỉnh máy Mac của bạn",
        description: "Chọn chip, bộ nhớ, dung lượng lưu trữ và cả màu sắc.",
      },
      {
        icon: "financing_tag", // Icon trả góp (Giả định)
        title: "Trả góp lãi suất 0%",
        description: "Ưu đãi trả góp lãi suất 0% trong 24 tháng.",
      },
    ],
  },
