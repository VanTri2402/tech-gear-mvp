...
import { menuIPhoneInfo } from "@/features/categories/constants/IphoneInfo"; // Đảm bảo đường dẫn đúng
...
import { IPhoneTopNav, IPadTopNav } from "./Nav"; // Import IPhoneTopNav nếu có, hoặc dùng IPadTopNav như cũ
import { SmoothScrollContainer } from "./smooth"; // Import SmoothScrollContainer
